...
import com.luck.agent.domain.entity.VectorDocumentRow;
import com.luck.agent.mapper.VectorDocumentMapper;
...
public class PostgreSQLVectorStore implements VectorStore {
    ...
    private static final Logger log = LoggerFactory.getLogger(PostgreSQLVectorStore.class);
