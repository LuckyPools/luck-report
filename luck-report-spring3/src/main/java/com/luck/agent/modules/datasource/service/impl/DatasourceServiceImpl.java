package com.luck.agent.modules.datasource.service.impl;

import com.luck.agent.modules.datasource.domain.dto.ColumnDTO;
import com.luck.agent.modules.datasource.domain.dto.SchemaDTO;
import com.luck.agent.modules.datasource.domain.dto.TableDTO;
...
import com.luck.agent.modules.datasource.handler.DatasourcePromptHelper;
import com.luck.agent.modules.datasource.handler.DatasourceTypeHandler;
import com.luck.agent.modules.datasource.handler.DatasourceTypeHandlerRegistry;
import com.luck.agent.modules.datasource.mapper.DatasourceMapper;
import com.luck.agent.modules.datasource.mapper.LogicalRelationMapper;
        ...
        for (String tableName : tables) {
            try {
                ...
                for (String col : columnDetails) {
                    ...
                    colMeta.put("samples", new com.google.gson.Gson().toJson(filteredSamples));
    ...
    private TableDTO buildTableDTOFromMetadata(VectorDocument tableDoc, List<VectorDocument> columnDocs) {
        ...
        for (VectorDocument colDoc : columnDocs) {
            ...
            if (StringUtils.isNotBlank(samplesStr)) {
                try {
                    List<String> samples = new com.google.gson.Gson().fromJson(samplesStr,
