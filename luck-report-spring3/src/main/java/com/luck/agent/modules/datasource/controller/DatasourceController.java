package com.luck.agent.modules.datasource.controller;

import com.luck.agent.modules.datasource.domain.dto.CreateLogicalRelationDTO;
import com.luck.agent.modules.datasource.domain.dto.DatasourceTypeDTO;
import com.luck.agent.modules.datasource.domain.dto.InitSchemaRequestDTO;
import com.luck.agent.modules.datasource.domain.dto.SchemaDTO;
import com.luck.agent.modules.datasource.domain.dto.UpdateLogicalRelationDTO;
import com.luck.agent.modules.datasource.domain.entity.LogicalRelation;
import com.luck.agent.modules.datasource.domain.enums.DatasourceTypeEnum;
import com.luck.agent.modules.datasource.domain.vo.DatasourceVO;
import com.luck.agent.modules.datasource.service.DatasourceService;
...
public class DatasourceController {
    ...
    public ApiResponse<DatasourceVO> create(@RequestBody DatasourceVO vo) {
        try {
            com.luck.agent.modules.datasource.domain.entity.Datasource entity = toEntity(vo);
     ...
     */
    @PostMapping("/{id}/schema-prompt")
    public ApiResponse<String> getSchemaPrompt(@PathVariable Integer id,
                                                @RequestParam(value = "query") String query) {
        try {
            String prompt = datasourceService.getSchemaPrompt(id, query);
     ...
     * @return 数据源实体
     */
    private com.luck.agent.modules.datasource.domain.entity.Datasource toEntity(DatasourceVO vo) {
        return com.luck.agent.modules.datasource.domain.entity.Datasource.builder()
                .id(vo.getId())
                .name(vo.getName())
                .type(vo.getType())
                .host(vo.getHost())
