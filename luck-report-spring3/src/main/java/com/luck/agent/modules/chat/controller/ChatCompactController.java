...
import com.luck.agent.modules.chat.domain.vo.CompactRequest;
import com.luck.agent.modules.chat.domain.vo.CompactResult;
import com.luck.agent.modules.chat.domain.vo.ContextMessage;
import com.luck.agent.domain.vo.ResultVO;
import com.luck.agent.modules.modelConfig.service.ModelConfigDataService;
import com.luck.agent.modules.chat.domain.vo.AskModelRequest;
import com.luck.agent.modules.chat.domain.vo.AskModelResponse;
import com.luck.agent.modules.chat.utils.ChatUtils;
...
public class ChatCompactController {
    ...
    private CompactResult parseCompactResult(String responseBody) {
        try {
            Map<String, Object> response = ChatUtils.getGson().fromJson(responseBody, Map.class);
            ...
            Map<String, Object> result = ChatUtils.getGson().fromJson(jsonStr, Map.class);
