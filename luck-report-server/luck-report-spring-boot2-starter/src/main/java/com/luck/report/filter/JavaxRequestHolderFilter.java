 ...
 * javax版本，用于Spring Boot2
 *
 * @author jack
 */
public class JavaxRequestHolderFilter implements Filter {
    private static final Logger logger = LoggerFactory.getLogger(JavaxRequestHolderFilter.class);
    private final RequestInfoProvider requestInfoProvider;

    public JavaxRequestHolderFilter(RequestInfoProvider requestInfoProvider) {
