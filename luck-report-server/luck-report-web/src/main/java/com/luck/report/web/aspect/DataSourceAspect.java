package com.luck.report.web.aspect;

import com.luck.report.web.annotation.DataSource;
import com.luck.report.web.config.DataSourceContextHolder;
 ...
 */
@Aspect
@Component("bean.dataSourceAspect")
@Order(1)
