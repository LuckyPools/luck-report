 ...
 * the License.
 ******************************************************************************/
package com.luck.report.web.modules.report.parser;

import com.luck.report.core.definition.*;
import com.luck.report.core.definition.CellStyle;
import com.luck.report.core.definition.PaperSize;
...
public class HSSFExcelParser extends ExcelParser {
    ...
    private CellStyle buildCellStyle(HSSFCell cell, HSSFWorkbook book) {
        ...
        if (!borderStyle.equals(BorderStyle.NONE)) {
            ...
            border.setStyle(com.luck.report.core.definition.BorderStyle.solid);
            border.setWidth(1);
