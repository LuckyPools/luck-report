...
import com.luck.report.core.definition.searchform.component.CheckboxGroupComponent;
import org.dom4j.Element;

import java.util.ArrayList;
import java.util.List;

public class CheckboxGroupParser implements FormParser<CheckboxGroupComponent> {
    @Override
    public CheckboxGroupComponent parse(Element element) {
        CheckboxGroupComponent component = new CheckboxGroupComponent();
    ...
    public boolean support(String name) {
        return name.equals("checkbox-group");
    }
}
