...
public class SumAggregate extends Aggregate {
    ...
    public List<BindData> aggregate(DatasetExpression expr, Cell cell, Context context) {
        ...
        if (leftList == null && topList == null) {
            ...
            result = buildSum(data, property, cell, expr, context, rows);
        } else if (leftList == null) {
            result = buildSum(topList, property, cell, expr, context, rows);
        } else if (topList == null) {
            result = buildSum(leftList, property, cell, expr, context, rows);
        } else {
    ...
    private BigDecimal buildSum(List<?> list, String property, Cell cell, DatasetExpression expr, Context context, List<Object> rows) {
