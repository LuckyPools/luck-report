...
import {DatasourceSchema, getBuildinDatasourceTemplate, validateDatasource, normalizeDatasource} from './schema/index'
...
export const addDatasourceTool: ToolDefinition<{
  ...
  execute: async ({ datasource }) => {
    ...
    return executeCode(`addDatasource({datasource:${JSON.stringify(normalized)}})`)
  },
  readOnly: false,
  requireConfirm: false,
